        ...
        try:
            ...
            match op:
                case 1:
                    ...
                    idade = int(idade_str)
                    usuario = Usuario(None,nome, idade, CPF)
                    UsuarioDAO.salvar_usuarios(usuario)
                ...
                case 5:
                    ...
                    livro_id_str = input("Digite o ID do livro: ").strip()

                    if not livro_id_str.isdigit():
                        print("ID do livro inválido!")
                        continue

                    livro_id = int(livro_id_str)
                    sucesso = LivroDAO.emprestar_livro(cpf, livro_id)
